    ...
    <div class="container">
        <div class="logo">
            <a href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('frontend/newstarland/images/logo.png')); ?>" alt="NEWSTARLAND - NGÔI SAO MỚI" class="img-responsive" width="200" height="46">
            </a>
        </div>
            ...
            <div class="collapse  navbar-collapse" id="buildpress-navbar-collapse">
                <ul id="menu-main-menu" class="navigation--main  js-dropdown">
                    ...
                    <li id="menu-item-2439" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2439">
                        ...
                        <ul class="sub-menu">
                            <li id="menu-item-2481"
                                ...
                                <a href="<?php echo e(route('projects', ['1'])); ?>">Vinhomes Times City</a>
                                <ul class="sub-menu">
                                    <li id="menu-item-3218"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-3218">
                                        <a href="<?php echo e(route('projects', ['1/project'])); ?>">Park 1 – Park Hill</a></li>
                    ...
                    <li id="menu-item-2432"
                        ...
                        <a href="<?php echo e(route('news.project')); ?>">TIN TỨC</a>
                        <ul class="sub-menu">
                    ...
                    <li id="menu-item-2461"
                        ...
                        <a href="<?php echo e(route('recruitment')); ?>">TUYỂN DỤNG</a></li>
