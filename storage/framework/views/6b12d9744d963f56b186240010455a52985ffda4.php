...
<section class="content-header">
  <h1>
   <i class="fa fa-user"></i> <?php echo e(Lang::get('core.m_users')); ?>
...
<div class="box box-danger ">
	<div class="box-header with-border">  <h4> <i class="fa fa-user"></i> </h4></div>
	<div class="box-body"> 	
		...
		<div class="col-md-6">
							...
							class='select2 '  required  ></select> 
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
										<input type='radio' name='active' value ='1' required <?php if($row['active'] == '1'): ?> checked="checked" <?php endif; ?> class="minimal-red" > Active 

										<input type='radio' name='active' value ='0' required <?php if($row['active'] == '0'): ?> checked="checked" <?php endif; ?> class="minimal-red" > Inactive

										<input type='radio' name='active' value ='2' required <?php if($row['active'] == '2'): ?> checked="checked" <?php endif; ?> class="minimal-red" > Banned
									 </div> 
									 <div class="col-md-2">
