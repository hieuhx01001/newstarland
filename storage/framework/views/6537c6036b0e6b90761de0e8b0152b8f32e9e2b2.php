...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("<?php echo e(URL::to('sximo/module/combotable')); ?>" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("<?php echo e(URL::to('sximo/module/combotablefield')); ?>?table=",
	...
	<?php $lv = explode("|", $f['option']['lookup_value']); ?>
		...
		$("#lookup_value1").jCombo("<?php echo e(URL::to('sximo/module/combotablefield')); ?>?table=",
		{ selected_value : "<?php echo (isset($lv[0]) ? $lv[0] : '');?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
		
		$("#lookup_value2").jCombo("<?php echo e(URL::to('sximo/module/combotablefield')); ?>?table=",
		{ selected_value : "<?php echo (isset($lv[1]) ? $lv[1] : '');?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
		
		$("#lookup_value3").jCombo("<?php echo e(URL::to('sximo/module/combotablefield')); ?>?table=",
...
<?php $formID = $row['formID'];?>
 		 ...
 		 <?php echo Form::open(array('url'=>'core/forms/field/'.$row['formID'], 'class'=>'form-vertical','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id'=>'formField')); ?>
...
<div class="form-vertical row">
  ...
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Field </label>
		<input type="text" class="form-control" name="field" required="true" value="<?php echo $f['field'];?>" <?php if($f['field'] !=''): ?> readonly="1" <?php endif; ?> />
  </div> 
