           ...
           <ul class="treeview-menu">
            ...
            <li <?php if(Request::segment(2) == 'users'): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('core/users')); ?>">
               <span> <?php echo e(Lang::get('core.m_users')); ?> & <?php echo e(Lang::get('core.m_groups')); ?></span>                
              </a>  
             </li>       
            
            
            <li <?php if(Request::segment(2) == 'pages'): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('core/pages')); ?>"><span><?php echo e(Lang::get('core.m_pagecms')); ?></span></a></li> 
            <li <?php if(Request::segment(2) == 'posts'): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('core/posts')); ?>"><span>Post Management</span></a></li>   
             <li <?php if(Request::segment(2) == 'logs'): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('core/logs')); ?>"><span><?php echo e(Lang::get('core.m_logs')); ?> </span></a></li>
           </ul>
