<?php echo Form::open(array('url'=>'core/forms/reorder/'.$row->formID, 'id'=>'formconfiguration')); ?>

<button type="button" onclick="SximoModal('<?php echo e(url("core/forms/input/".$row->formID)); ?>','New Input')" class="btn  btn-success btn-sm" ><i class="fa fa-plus"></i> New Input </button> 
