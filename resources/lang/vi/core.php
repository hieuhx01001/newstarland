...
"norecord"			=> "Không tìm thấy dữ liệu",  
 ...
 "conewpassword"			=> "Xác Nhận ",  
 "notepassword"			=> "Để trống nếu bạn không muốn thay đổi",  
 "submit"			=> "Thay Đổi",  
 "signin"			=> "Sign In",  
 "signup"			=> "Sign Up",  
 "subscribe"			=> "Subscribe",  
