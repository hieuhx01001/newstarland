                                    ...
                                    {{--@if($socialize['google']['client_id'] !='' || $socialize['twitter']['client_id'] !='' || $socialize['facebook'] ['client_id'] !='')--}}
                                        ...
                                        {{--<div class="social-auth-links text-center">--}}
                                            ...
                                            {{--@if($socialize['facebook']['client_id'] !='')--}}
                                                {{--<a href="{{ URL::to('user/socialize/facebook')}}" class="btn btn-block btn-social btn-facebook btn-flat">--}}
                                                    {{--<i class="fa fa-facebook"></i>--}}
                                                    {{--Sign in using Facebook--}}
                                                {{--</a>--}}
                                            {{--@endif--}}
                                            {{--@if($socialize['google']['client_id'] !='')--}}
                                                {{--<a href="{{ URL::to('user/socialize/google')}}" class="btn btn-block btn-social btn-google btn-flat">--}}
                                                    {{--<i class="fa fa-google-plus"></i>--}}
                                                    {{--Sign in using Google+--}}
                                                {{--</a>--}}
                                            {{--@endif--}}
                                            {{--@if($socialize['twitter']['client_id'] !='')--}}
                                                {{--<a href="{{ URL::to('user/socialize/twitter')}}" class="btn btn-block btn-social btn-twitter btn-flat">--}}
