        ...
        <div class="box box-primary ">
            <div class="box-header with-border">
                <div class="box-header-tools pull-left">
                    ...
                    @endif
                    <a href="{{ URL::to( 'core/users/search') }}" class="btn btn-sm btn-default" onclick="SximoModal(this.href,'Advance Search'); return false;">
                ...
                <div class="box-header-tools">
                    <a href="{{ url($pageModule) }}" class="btn btn-sm btn-default tips" title="Clear Search">
                        <i class="fa fa-spinner"></i>
                    </a>
                    @if(Session::get('gid') ==1)
                        <a href="{{ URL::to('sximo/module/config/users') }}" class="btn btn-sm btn-default tips" title=" {{ Lang::get('core.btn_config') }}">
            ...
            <div class="box-body no-padding">
                ...
                <div class="table-header">
                    <ul class="nav nav-tabs ">
                        <li class="active">
                            <a href="{{ URL::to('core/users')}}"> {{ Lang::get('core.m_users') }}  </a>
                        </li>

                        @if(Auth::user()->group_id == 1  )
                            <li>
                                <a href="{{ URL::to('core/groups')}}"> {{ Lang::get('core.m_groups') }} </a>
                            </li>

                            <li class="">
                                <a href="{{ URL::to('core/users/blast')}}"> Send Email</a>
                            </li>
                        @endif
                    </ul>
                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                @if($access['is_detail'] ==1)
                                                    <li>
                                                        <a href="{{ URL::to('core/users/show/'.$row->id.'?return='.$return)}}" class="tips" title="{{ Lang::get('core.btn_view') }}">
                                                ...
                                                @if($access['is_edit'] ==1)
                                                    <li>
                                                        <a href="{{ URL::to('core/users/update/'.$row->id.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}">
