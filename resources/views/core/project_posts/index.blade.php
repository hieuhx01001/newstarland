                ...
                <div class="box box-info ">
                    <div class="box-header with-border">
                        <div class="box-header-tools pull-left">
                            @if($access['is_add'] ==1)
                                <a href="{{ URL::to('core/projectposts/update?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_create') }}">
                            ...
                            @endif
                            <a href="{{ URL::to( 'core/projectposts/search') }}" class="btn btn-xs btn-default" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}">
                        ...
                        <div class="box-header-tools pull-right">
                            @if($access['is_excel'] ==1)
                                <a href="{{ URL::to('core/projectposts/download?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_download') }}">
                                    <i class="fa fa-cloud-download"></i>
                                </a>
                            @endif

                            <a href="{{ url($pageModule) }}" class=" tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_clearsearch') }}">
                    ...
                    <div class="box-body no-padding">
                        ...
                        {!! Form::open(array('url'=>'core/projectposts/delete?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
                                ...
                                <tbody>
                                    @foreach ($rowData as $row)
                                        <tr>
                                            {{--<td width="30"> {{ ++$i }} </td>--}}
                                            <td width="50">
                                                <input type="checkbox" class="ids" name="ids[]" value="{{ $row->pageID }}"/>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        @if($access['is_detail'] ==1)
                                                            <li>
                                                                <a href="{{ url('post/view/'. $row->pageID.'/'.$row->alias)}}" class="tips" title="{{ Lang::get('core.btn_view') }}" target="_blank">
                                                        ...
                                                        @if($access['is_edit'] ==1)
                                                            <li>
                                                                <a href="{{ URL::to('core/projectposts/update/'.$row->pageID.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}">
                                                                    <i class="fa fa-edit "></i> {{ Lang::get('core.btn_edit') }}
                                                                </a>
                                                            </li>
                                                        @endif
                                                    </ul>
            ...
            <div class="tab-pane" id="config">
                ...
                <div class="box box-primary ">
                    ...
                    <div class="box-body">
                        ...
                        {!! Form::open(array('url'=>'core/projectposts/config', 'class'=>'form-horizontal' ,'id' =>'' )) !!}
