                ...
                <div class="box box-info ">
                    <div class="box-header with-border">
                        <div class="box-header-tools pull-left">
                            ...
                            @endif
                            <a href="{{ URL::to( 'core/posts/search') }}" class="btn btn-xs btn-default" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        @if($access['is_edit'] ==1)
                                                            <li>
                                                                <a href="{{ URL::to('core/posts/update/'.$row->pageID.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}">
