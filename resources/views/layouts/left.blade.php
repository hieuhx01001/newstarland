        ...
        <ul class="sidebar-menu">
            ...
            <li class="header">ADMINISTRATOR</li>
                @if($this->access !== false)
                    <li @if(Request::segment(2) == 'users') class="treeview active" @else class="treeview" @endif >
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li @if(Request::segment(1) == 'projectcategory') class="active" @endif>
                        <a href="{{ url('projectcategory')}}"><span>Danh Mục</span></a>
                    </li>

                    <li @if(Request::segment(2) == 'projectposts') class="active" @endif>
                        <a href="{{ url('core/projectposts')}}"><span>Danh Sách Dự Án</span></a>
                    </li>
                </ul>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    {{--<a href="{{ url('core/pages')}}"><span>{{ Lang::get('core.m_pagecms')}}</span></a>--}}
                    {{--</li>--}}
                    <li @if(Request::segment(1) == 'category') class="active" @endif>
                        <a href="{{ url('category')}}"><span>Danh Mục</span></a>
                    </li>

                    <li @if(Request::segment(2) == 'posts') class="active" @endif>
                        <a href="{{ url('core/posts')}}"><span>Bài Viết</span></a>
                    </li>
                    {{--<li @if(Request::segment(2) == 'logs') class="active" @endif>--}}
                    {{--<a href="{{ url('core/logs')}}"><span>{{ Lang::get('core.m_logs') }} </span></a>--}}
                    {{--</li>--}}
                </ul>

            </li>
                @if ($this->logAccess !== false)
                <li @if(Request::segment(2) == 'logs') class="treeview active" @else class="treeview" @endif >
                    <a href="{{ url('core/logs')}}">
